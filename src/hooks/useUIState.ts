...
export const useUIState = () => {
  ...
  /**
   * Toggle unified creator modal visibility
   */
  const toggleUnifiedCreator = useCallback(() => {
    setShowUnifiedCreator(prev => !prev)
  }, [])

  /**
   * Open unified creator modal
   */
  const openUnifiedCreator = useCallback(() => {
    setShowUnifiedCreator(true)
  }, [])

  /**
   * Close unified creator modal
   */
  const closeUnifiedCreator = useCallback(() => {
